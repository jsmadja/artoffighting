========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet rom_add
========================================================================

AppWizard a cr&eacute;&eacute; cette application rom_add pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application rom_add.
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; rom_add.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
